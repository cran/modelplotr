...
#'   \code{\link{prepare_scores_and_ntiles_keras}} function.
...
#'   \code{prepare_scores_and_ntiles} (or with \code{prepare_scores_and_ntiles_keras} or created otherwise, with similar layout). }
